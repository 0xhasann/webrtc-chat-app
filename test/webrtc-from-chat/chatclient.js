...
async function createPeerConnection() {
  ...
  // Optional TURN config for stricter NAT environments.
  if (window.CHAT_TURN_URL && window.CHAT_TURN_USERNAME && window.CHAT_TURN_CREDENTIAL) {
    iceServers.push({
      urls: window.CHAT_TURN_URL,
      username: window.CHAT_TURN_USERNAME,
      credential: window.CHAT_TURN_CREDENTIAL
    });
  }
