...
const keyFilePath = process.env.WRTC_KEY_PATH || "/etc/pki/tls/private/mdn-samples.mozilla.org.key";
const certFilePath = process.env.WRTC_CERT_PATH || "/etc/pki/tls/certs/mdn-samples.mozilla.org.crt";
...
if (!httpsOptions.key || !httpsOptions.cert) {
  log("TLS certificate/key not found. Starting in HTTP mode.");
  log("Set WRTC_KEY_PATH and WRTC_CERT_PATH to enable HTTPS.");
}
